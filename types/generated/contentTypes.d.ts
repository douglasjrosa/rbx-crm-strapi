...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    decisionRole: Schema.Attribute.String;
    email: Schema.Attribute.String;
...
export interface ApiDealDeal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    followUpAt: Schema.Attribute.DateTime;
    interactions: Schema.Attribute.Relation<
      'oneToMany',
      'api::interaction.interaction'
    >;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::deal.deal'> &
      Schema.Attribute.Private;
    migrationId: Schema.Attribute.Integer;
    ...
    > &
      Schema.Attribute.DefaultTo<'Send proposal'>;
...
export interface ApiIssuerIssuer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blingAccessToken: Schema.Attribute.Text;
    blingClientId: Schema.Attribute.Text;
    blingClientSecret: Schema.Attribute.Text;
    blingExpiresIn: Schema.Attribute.Integer;
    blingRefreshToken: Schema.Attribute.Text;
    company: Schema.Attribute.Relation<'oneToOne', 'api::company.company'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    clientOrderCode: Schema.Attribute.String;
    company: Schema.Attribute.Relation<'oneToOne', 'api::company.company'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deal: Schema.Attribute.Relation<'oneToOne', 'api::deal.deal'>;
    deliverForecast: Schema.Attribute.Date;
    extraCosts: Schema.Attribute.Decimal;
    freightType: Schema.Attribute.String;
    freightValue: Schema.Attribute.Decimal;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    issuer: Schema.Attribute.Relation<'oneToOne', 'api::issuer.issuer'>;
    items: Schema.Attribute.Component<'order-components.items', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPaymentMethodPaymentMethod
  ...
  attributes: {
    blingAccountCnpj: Schema.Attribute.BigInteger;
    blingAccountName: Schema.Attribute.String;
    blingPaymentMethodId: Schema.Attribute.BigInteger;
    conditions: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
